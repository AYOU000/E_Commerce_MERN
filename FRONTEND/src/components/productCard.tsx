  ...
  return (
    ...
    >
      ...
      <Box sx={{
        position: "absolute",
        inset: 0,
        background: "linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.45) 40%, transparent 70%)",
      }} />
      ...
      <Box sx={{
        ...
        <Box
          onClick={(e) => { e.stopPropagation(); addItemToCart(_id); }}
          sx={{
            background: "#FFE600",
            color: "#000",
            fontFamily: '"Orbitron", monospace',
      ...
      <Box sx={{
        ...
        background: "linear-gradient(135deg,rgba(255,230,0,0.06) 0%,transparent 50%)",
        opacity: hovered ? 1 : 0,
        transition: "opacity 0.2s",
        pointerEvents: "none",
      }} />
