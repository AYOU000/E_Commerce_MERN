...
const AccountPage = () => {
  ...
  const { username, token, updated } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      updated(NewEmail!, data.token);
      setSuccess("Email updated successfully!");
      if (NewEmailRef.current) NewEmailRef.current.value = "";      
      if (VerifyEmailRef.current) VerifyEmailRef.current.value = "";
    } catch (err) {
      console.log(err);
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                backgroundColor: "#FFE600",
                boxShadow: "0 0 16px rgba(255,230,0,0.5)",
              },
            }}
          >
            SAVE CHANGES
